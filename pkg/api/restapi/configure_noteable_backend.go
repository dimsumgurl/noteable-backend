...
//go:generate swagger generate server --target ../../api --name NoteableBackend --spec ../noteable.yaml --principal interface{} --exclude-main

func configureFlags(api *operations.NoteableBackendAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.NoteableBackendAPI) http.Handler {
